...
import net.xijko.arche.block.screen.SoilTableScreen;
...
public class SoilTableRestoreMessage {
    ...
    private static SoilTableScreen screen;
    private static World world;
    private static BlockPos pos;

    public SoilTableRestoreMessage(SoilTableScreen screen, World world, BlockPos pos) {
        super();
        this.screen = screen;
        this.world  = world;
        this.pos = pos;
    ...
    public static void restoreItem(SoilTableScreen screen, World world, BlockPos pos, ServerPlayerEntity player){
        LOGGER.warn(world + " " + pos);
        SoilTableTile tile = (SoilTableTile) world.getTileEntity(pos);
