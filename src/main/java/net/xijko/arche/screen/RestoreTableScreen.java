...
public class RestoreTableScreen extends ContainerScreen<RestoreTableContainer> {
    ...
    public RestoreTableScreen(RestoreTableContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
